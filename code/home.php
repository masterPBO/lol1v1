  ...
  <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar3SupportedContent">
        ...
        <a class="btn navbar-btn btn-outline-light" href="match.php">Matches<br></a>
    ...
    <div class="container my-auto">
      <div class="row big-title" style="">
        <div class="mx-auto col-lg-6 col-md-8" style="">
          <h1 class="display-1 mb-0 mt-5 text-capitalize text-justify">Leagueskill.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 1v1</h1>
          <h3 class="mb-4"><b>Find opponents to improve your mechanics and skill in 1v1.</b></h3>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-10 mx-auto px-4">
          ...
          <div class="row text-left">
            ...
            <div class="p-3 col-lg-4 col-md-6">
              <div class="row mb-3">
                <div class="align-self-center d-flex align-items-center px-0 px-md-2 col-9 col-md-12">
                  <h5 class="mb-0"><b>2.Find matches</b></h5>
                </div>
              </div>
            </div>
